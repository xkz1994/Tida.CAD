...
namespace Tida.Canvas.Shell.Contracts.StatusBar
{
    ...
    public abstract class StatusBarCheckBoxItem : StatusBarItemBase
    {
        ...
        {
            get { return _checkBox.IsThreeState; }
            set { _checkBox.IsThreeState = value; }
        }
        ...
        public Brush Foreground
        {
            ...
            set { _checkBox.Foreground = value; }
        }
        ...
        {
            get { return _checkBox.Margin; }

            set { _checkBox.Margin = value; }
        }

        public object Content
        {
            get { return _checkBox.Content; }
