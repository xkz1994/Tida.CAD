...
{
    [ExportPropertyDescriptor(Inheritable = true, CategoryNameKey = CategoryName_Geometry, DescriptionNameKey = DescriptionName_Line2D, DisplayNameKey = DisplayName_Line2D, IsReadOnly = false, EditorTypeGUID = EditorType_Line2D, EditorStyle = EditorStyle.DropDown,
        EditorTargetProperty = EditorTargetProperty_Line2D)]
