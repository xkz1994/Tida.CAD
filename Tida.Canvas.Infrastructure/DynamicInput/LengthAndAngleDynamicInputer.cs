...
namespace Tida.Canvas.Infrastructure.DynamicInput
{
        ...
        NumberBoxesDynamicInputer where THaveMousePositionTracker : class, IHaveMousePositionTracker, IInputElement
    {
        public LengthAndAngleDynamicInputer(THaveMousePositionTracker haveMousePositionTracker, ICanvasControl canvasControl, INumberBoxService numberBoxService) :
            base(
                LengthAndAngleNumContainerForMouseTrackable<THaveMousePositionTracker>.CreateFromHaveMousePositionTracker(haveMousePositionTracker, canvasControl.CanvasProxy),
                canvasControl,
                numberBoxService
            )
        {
